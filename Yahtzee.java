...
public class Yahtzee extends GraphicsProgram implements YahtzeeConstants {
	 ...
	 * in the first scenario, there will be two players - the player and the computer,
	...
	public void run() {
		...
		int against_computer = dialog.readInt("Enter 1 if you want to play agains computer, or write 0, if you don't want.");
		while(against_computer != 1 && against_computer != 0) {
			against_computer = dialog.readInt("\"Enter 1 if you want to play agains computer, or write 0, if you don't want.\"");
		}
